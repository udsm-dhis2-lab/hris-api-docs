...
1. Select "Fields from" the menu on the left hansd side of the application.
...
2. Select "Delete" from the options displayed.
...
![img alt](/images/selectingEditFieldOption.png)
...
![img alt](/images/showFieldOptionDetails.png)
